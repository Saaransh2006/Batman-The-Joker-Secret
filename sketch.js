...
function draw() {
    ...
    if(gameState === "initial1") {
        ...
        text("Recap:",800,30);
        textStyle(NORMAL);
        text("Batman, Gotham city's superhero killed the Joker, a psychotic villain, a",800,55);
        text("few months back. In the present day, a new joker suddenly appears on",800,85);
        text("the streets of Gotham and kidnaps Batman's adopted son and his partner,",800,115);
        text("Robin. Meanwhile, the people of Gotham start fighting each other just",800,145);
        text("because some trust Batman, while some don't. Batman faces The New",800,175);
        text("Joker; but he ends up running away, leaving Batman in an injured state.",800,205);
        text("(Few days after the first fight, Batman finally finds the New Joker's",800,245);
        text("place)",800,275);
        fill("white");
        text("Batman(angrily): I'll not leave you this time!",800,305);
        text("(New Joker comes out, and Batman is shocked to see the him in Robin's",800,335);
        text("suit!)",800,365);
        text("Batman: What! Why are you wearing Robin's dress? Where's Robin!!!!",800,395);
        text("Joker(in Robin's voice): Everyone has their secrets, and this is mine!!!",800,425);
        text("HAHAHAHA!",800,455);
